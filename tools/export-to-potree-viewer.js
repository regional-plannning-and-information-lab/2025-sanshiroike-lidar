...
const rawPotreeDir = '/usr/src/potree/pointclouds/sanshiroike-raw';

// 補正後のPotreeファイルのディレクトリ
const transformedPotreeSourceDir = path.resolve(__dirname, './potree-files/transformed-combined');
const transformedPotreeDir = '/usr/src/potree/pointclouds/sanshiroike-transformed';

// ビューワーのHTMLファイルを生成するディレクトリ
const htmlDir = '/usr/src/potree/examples/';
